...
const SKINS: Array = [
	preload("res://Assets/Player Sprites/Skin 1/p3_stand.png"),
	preload("res://Assets/Player Sprites/Skin 2/p2_stand.png"),
	preload("res://Assets/Player Sprites/Skin 3/p1_stand.png")
]
